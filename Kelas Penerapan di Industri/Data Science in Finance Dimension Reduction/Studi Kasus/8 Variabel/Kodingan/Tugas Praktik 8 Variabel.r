# Pada bagian ini kita akan melakukan Principal Component Analysis untuk 8 variabel prediktor numerik dalam data credit rating. Tahap-tahap yang akan dilakukan adalah:
# 1. Membaca data
...
# Ikuti 16 langkah di bawah ini untuk melakukan Principal Component Analysis untuk 8 variabel prediktor numerik dalam data credit rating. Gantilah baris yang diawali dengan tanda #[1] dan seterusnya dengan kode yang diminta.
